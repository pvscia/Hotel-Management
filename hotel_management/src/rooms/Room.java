...
public class Room {
	private String bedType, roomType, roomView,avaibility,guest;
	private int roomSize, roomCapacity, roomNumber,roomPrice;
	private boolean do_not_disturb,wake_up_call;
	public Room(String bedType, String roomType, String roomView, String avaibility, String guest, int roomSize,
